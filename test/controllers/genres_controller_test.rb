...
class GenresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create genre" do
    assert_difference("Genre.count") do
      post genres_url, params: { genre: { genre_id: @genre.genre_id, genre_name: @genre.genre_name } }
    end
  ...
  test "should update genre" do
    patch genre_url(@genre), params: { genre: { genre_id: @genre.genre_id, genre_name: @genre.genre_name } }
